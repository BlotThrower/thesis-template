...
\newcommand{\titel}{Verbessertes Routing für Fahrradfahrer – Klassifizierung von Smartphone-Sensordaten zur Erkennung von Bodenbelag und -qualität
}
\newcommand{\artderarbeit}{Bachelorarbeit}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{Christian Gügel}
\newcommand{\studiengang}{Medieninformatik}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
\newcommand{\matrikelnr}{364\,3206}
